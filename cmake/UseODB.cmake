...
function(odb_compile outvar)
	...
	if(PARAM_PROJECT_INCLUDE)
		...
		foreach(fp ${full_paths})
			...
			# e.g. "DBObject.h" with "<sempr/storage/DBObject.h>"
			get_filename_component(bare ${trimmed} NAME)
			list(APPEND ODB_ARGS --include-regex "%${bare}%${trimmed}%")
		endforeach()
	endif()
	list(APPEND ODB_ARGS --include-regex "%(.+)/(.+)_odb.h%$2_odb.h%")
	# list(APPEND ODB_ARGS "--include-regex-trace")
